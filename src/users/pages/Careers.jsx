  ...
  return (
    <>
      ...
      <div className='py-5 flex flex-col px-10'>
        <h1>Current Openings</h1> <hr className='w-31 mt-2' />
        <div className="flex items-center justify-center my-5">
          ...
          <button className='bg-cyan-500 ms-2 rounded w-20 h-10.5'>Search</button>
        </div>
        {/* job details div */}
        <div className='md:px-10 px-5 md:py-10 py-5 border rounded border-gray-300'>
          <div className='  flex justify-between'>
            <h1 className=' text-lg md:text-xl md:mt-3 mt-2 text-gray-500'>Job Title</h1>
            <button className=' text-white rounded bg-sky-600 md:px-5 px-2 md:py-3 py-1'>Apply now <FontAwesomeIcon icon={faArrowRightFromBracket} className='ms-3' /></button>
          </div>
